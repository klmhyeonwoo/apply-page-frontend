  ...
  useEffect(() => {
    if (ModalRef.current != null) {
      ...
      ModalRef.current.style.top = `${
        (window.screen.height - 480) / 4 + window.scrollY
      }px`;
    }
  }, []);
          ...
          >
            {props.imgSrc && (
              <img
                ...
                css={css`
                  width: 9.4em;
                  ${props.alt === "찾기" && "width: 9.5em;"}
                  ${props.alt === "최종제출" && "width: 7.5em;"}
                            ${props.alt === "불러오기" && "width: 7.5em;"}
                            margin-bottom: 2em;
                `}
              />
            )}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>
          · 작성 중인 지원서는 임시저장 버튼을 통해 실시간으로 저장이
          가능합니다.
        </span>
        <span>
        ...
        <span>
          · 문항에 따른 올바른 입력을 해주셔야 지원서의 다음 단계로 이동하실 수
          있습니다.
        </span>
        <span>
          · 지원서의 내용이 사실과 다를 경우, 합격이 취소되거나 전형 상의
          불이익을 받을 수 있습니다.
        </span>
        <span>
          · 지원서는 문항별 최대 1000자의 제한을 두고 있으나, 문항을 다 채우실
          필요는 없습니다.
        </span>
        <span>
          · 문의사항은 우측 하단 채널 톡으로 문의해주시면 최대한 빠르게
          도와드리겠습니다.
        </span>
      </div>
    </div>
